...
<head>
    ...
    <title>BloodBank & Donor | 헌혈자 찾기</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">헌혈자 찾기</h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">헌혈자 찾기</li>
        </ol>
...
$sql = "SELECT * from donor where (BloodGroup='$bloodgroup' and Address like '%$location%')";
$query = $dbh -> prepare($sql);
